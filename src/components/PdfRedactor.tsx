  ...
  if (isLoading) {
    return (
      ...
      >
        ...
        <p style={{ color: '#666' }}>
          Bitte warten Sie, während das Dokument verarbeitet wird.
        </p>
      </div>
    )
  }
    ...
    <div className='pdfRedactor' style={{ display: 'flex', height: '100%' }}>
      ...
      >
        ...
        >
          ...
          >
            <span style={{ fontWeight: 'bold', fontSize: '16px', marginRight: '8px', userSelect: 'none' }}>−</span>
            <input
              type='range'
              min='0'
              max='100'
          ...
          <div style={{ position: 'relative' }} ref={dropdownRef}>
            ...
            {isDropdownOpen && (
              ...
              >
                ...
                >
                  <span style={{ marginRight: '8px' }}>🟨</span> Vorgeschwärzt
                </div>
                <div
                  style={{ padding: '8px 16px', cursor: 'pointer', display: 'flex', alignItems: 'center' }}
                  ...
                  onMouseLeave={e => (e.currentTarget.style.backgroundColor = 'transparent')}
                >
                  <span style={{ marginRight: '8px' }}>⬛️</span> Final geschwärzt
                </div>
              </div>
            )}
          </div>
